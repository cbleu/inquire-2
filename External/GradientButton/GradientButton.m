...
- (void)useSimpleWithColor:(UIColor *)baseColor {
	NSMutableArray *colors = [NSMutableArray arrayWithCapacity:2];
	UIColor *color = baseColor;
	color = [UIColor colorWithRed:baseColor.red green:baseColor.green blue:baseColor.blue alpha:1.0];
	[colors addObject:(id)[color CGColor]];
	color = [UIColor colorWithRed:baseColor.red green:baseColor.green blue:baseColor.blue alpha:0.4];
	[colors addObject:(id)[color CGColor]];
...
- (void)useSimpleWithColor:(UIColor *)baseColor gradientColor:(UIColor *)gradientColor {	
    NSMutableArray *colors = [NSMutableArray arrayWithCapacity:2];
	UIColor *color = baseColor;
	color = [UIColor colorWithRed:baseColor.red green:baseColor.green blue:baseColor.blue alpha:1.0];
	[colors addObject:(id)[color CGColor]];
	color = [UIColor colorWithRed:gradientColor.red green:gradientColor.green blue:gradientColor.blue alpha:0.4];
	[colors addObject:(id)[color CGColor]];
